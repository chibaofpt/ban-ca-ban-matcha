...
export default function AdminVoucherPackagesPage() {
  ...
  return <main className="mx-auto w-full min-w-0 max-w-6xl space-y-5 overflow-x-clip overscroll-x-none px-4 py-6 pb-28 md:px-8">

...
/** Displays the customer menu with sticky tab bar and scroll-based section navigation. */
export default function MenuPage() {
  ...
  /** Update active tab based on which section is currently visible while scrolling. */
  useEffect(() => {
